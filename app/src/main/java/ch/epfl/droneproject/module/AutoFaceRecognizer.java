 ...
 *
 * Created on Dec 7, 2011, 1:27:25 PM Edited by Bastien Chatelain on Dec 2017
 *
 ...
 *
 * AutoFaceRecognizer is free software: you can redistribute it and/or modify
...
public class AutoFaceRecognizer {
    ...
    private void storeTrainingData() {
        ...
        System.out.println("writing data/facedata.xml");

        // create a file-storage interface
        fileStorage = cvOpenFileStorage(
                "H:\\MyWork\\facerecognition\\javacv-02385ce192fb\\facerecExample_ORL\\face-recognition-opencv-4507c787a306/facedata.xml", // filename
                null, // memstorage
        ...
        for (i = 0; i < nPersons; i++) {
            ...
            cvWriteString(
                    fileStorage, // fs
                    varname, (String) personNames.get(i), // string
                    0); // quote
        }
    ...
    private CvMat loadTrainingData() {
        ...
        if (fileStorage == null) {
            ...
            Log.e(TAG,"Can't open training database file 'data/facedata.xml'.");
            return null;
        }
        ...
        nPersons = cvReadIntByName(
                ...
                0); // default_value
        if (nPersons == 0) {
            Log.e(TAG,"No people found in the training database 'data/facedata.xml'.");
            return null;
        } else {
    ...
    private void storeEigenfaceImages() {
        ...
        cvSaveImage("H:\\MyWork\\facerecognition\\javacv-02385ce192fb\\facerecExample_ORL\\data/out_averageImage.bmp", pAvgTrainImg);
    ...
    public void startRecognition() {
        ...
        final AutoFaceRecognizer faceRecognition = new AutoFaceRecognizer();
        //faceRecognition.learn("data/some-training-faces.txt");
        faceRecognition.learn("H:\\MyWork\\facerecognition\\javacv-02385ce192fb\\facerecExample_ORL\\all10.txt");
        //faceRecognition.recognizeFileList("data/some-test-faces.txt");
        faceRecognition.recognizeFileList("H:\\MyWork\\facerecognition\\javacv-02385ce192fb\\facerecExample_ORL\\lower3.txt");
    }
}
