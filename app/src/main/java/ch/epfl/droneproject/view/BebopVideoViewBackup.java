...
public class BebopVideoViewBackup extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public BebopVideoViewBackup(Context context) {
        super(context);
        customInit();
    }

    public BebopVideoViewBackup(Context context, AttributeSet attrs) {
        super(context, attrs);
        customInit();
    }

    public BebopVideoViewBackup(Context context, AttributeSet attrs, int defStyleAttr) {
